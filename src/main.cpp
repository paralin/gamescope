...
const char usage[] =
	...
	"  --libinput-hold-dev            Comma seporated list of evdev path devices that will become the handlers on the nested window (SDL & VR ONLY)\n"
	"  --backend-disable-keyboard     Disables the normal backend keyboard support (window will not handle keyboard) (SDL ONLY)\n"
	"  --backend-disable-mouse        Disables the normal backend mouse support (window will not handle mouse) (SDL ONLY)\n"
	"\n"
	"Embedded mode options:\n"
